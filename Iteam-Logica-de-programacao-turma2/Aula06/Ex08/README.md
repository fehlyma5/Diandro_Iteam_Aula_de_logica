# Exercício 08 — Número Positivo

**Aula 6 — Estruturas de Repetição**

## Enunciado

Solicite ao usuário um número inteiro, repita a leitura até que seja informado um número maior que zero. Depois exiba o número digitado. Estrutura: REPITA.
